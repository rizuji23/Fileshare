...
<div class="container-fluid">
    <div class="jumbotron">
     ...
     require 'functions.php';
      ...
      <form method="post" action="foldermake.php" method="POST">
      ...
      <label style="color: white;">Upload File</label>  
        ...
        <div class="form-group">  
        <input type="submit" name="simpan" onclick="upload()" class="btn btn-primary" value="Simpan"><br>
        </div>
      </form>
